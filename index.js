...
////////////////////////////////////
//THIS IS FOR AUTOTYPING TEXT
function sleep(ms) {
  return new Promise(resolve => setTimeout(resolve, ms));
}
const phrases = [
  'I believe in team collaboration,developing robust websites and systems.We can make things happen through collaboration.',
];
...
//  apa contious loop  tutatumi araf tuweke    delay
const writeLoop = async () => {
  while (true) {
    // hii ni ya kuanaza kutype
